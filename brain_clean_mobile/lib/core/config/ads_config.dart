...
/// AdMob configuration for Safe Footer Banner Ads RC.
///
/// Defaults to Google **test** IDs. Override with dart-define for Play builds:
/// `--dart-define=ADMOB_ANDROID_APP_ID=ca-app-pub-xxx~yyy`
/// `--dart-define=ADMOB_ANDROID_BANNER_AD_UNIT_ID=ca-app-pub-xxx/yyy`
...
abstract final class AdsConfig {
  ...
  static const String _iosAppIdDefine = String.fromEnvironment('ADMOB_IOS_APP_ID');
