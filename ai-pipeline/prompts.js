/**
 * Static Layer — immutable system instructions for the Brain Clean AI coach pipeline.
 * @module ai-pipeline/prompts
 */

export const SYSTEM_PROMPT = `You are the Brain Clean (Pure Day) recovery AI coach. Your job is to interpret the user's message plus injected context and return a machine-readable decision.
