...
abstract final class RecoveryPracticeCatalog {
  ...
  static final List<RecoveryPractice> _practices = [
    ...
    RecoveryPractice(
      ...
      version: RecoveryPlanVersions.practiceVersion,
      nameEn: 'Brief settle breath',
      nameAr: 'تنفّس تهدئة قصير',
      targetDomainTags: const ['mood', 'pulse', 'recovery'],
      purposeEn: 'A short settling breath to steady attention.',
      purposeAr: 'تنفّس قصير لتهدئة الانتباه.',
      minimumPathEn: '3 slow breaths',
      minimumPathAr: '3 أنفاس بطيئة',
      standardPathEn: '1-min paced breathing',
      standardPathAr: 'تنفّس بإيقاع لمدة دقيقة',
      durationMinutesMin: 1,
      durationMinutesMax: 3,
      completionRule: completionRule,
      skipBehavior: skipBehavior,
      accessibilityAltEn: 'Eyes-open counting breaths',
      accessibilityAltAr: 'عدّ الأنفاس والعينان مفتوحتان',
      offline: true,
      starterOnly: false,
      safetyBoundaryEn: 'Stop if distress rises; no forced exposure.',
      safetyBoundaryAr: 'توقف إذا زاد الضيق؛ بلا تعريض قسري.',
